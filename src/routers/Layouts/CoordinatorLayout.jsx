...
import CoordinatorAsider from '../../component/CoordinatorAsider.jsx';
...
export const  CoordinatorLayout = () => {
 const [sidebarCollapsed, setSidebarCollapsed] = useState(() => localStorage.getItem('dashboard-sidebar-collapsed') === 'true');
  ...
  const showEventNav = location.pathname.startsWith('/coordinator/events');
  const eventLinks = [{ to: '', label: 'Events', end: true }];
  ...
  return (
   <>
    <div className="dashboard-container ">
           <CoordinatorAsider sidebarRef={sidebarRef} />
